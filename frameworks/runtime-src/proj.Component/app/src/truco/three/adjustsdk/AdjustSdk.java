...
public class AdjustSdk implements Adjustface {
    ...
    private static String _apptoken = "m6d84e3j73eo";
    @Override
    ...
    public static String getAdjustAttribution(){
        ...
        try {
            if (null!=aa){
                ...
                if (aa.costType!=null){
                    result.put("costType", aa.costType);
                }
                if (aa.costAmount!=null){
                    result.put("costAmount", aa.costAmount);
                }
                if (aa.costCurrency!=null){
                    result.put("costCurrency", aa.costCurrency);
                }
                if (aa.fbInstallReferrer!=null){
                    result.put("fbInstallReferrer", aa.fbInstallReferrer);
                }
            }
    ...
    public static void adjustLogEvent(String data){
        ...
        Log.d(mTag, "adjustLogEvent ChannelId:"+ LooqzlGoodGameActivity.getChannelId());
