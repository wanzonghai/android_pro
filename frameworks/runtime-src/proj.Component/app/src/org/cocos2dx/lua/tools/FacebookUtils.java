...
public class FacebookUtils {
    ...
    static AppTMGActivity m_activity;
     ...
     * 初始化SDK
     */
    public static void initSDK(AppTMGActivity activity)
    {
...
//                        Utils.reportShareResult("error");
    ...
    public static void FaceBookLogin() {
        ...
        LoginManager.getInstance().logInWithReadPermissions((AppTMGActivity) m_activity.getContext(), Arrays.asList("public_profile"));
    }
