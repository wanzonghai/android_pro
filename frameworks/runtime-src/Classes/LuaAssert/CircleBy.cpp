...
CirCleByManager *CirCleByManager::create(float t, cocos2d::Vec2 circleCenter, float radius)
{
    
    CirCleByManager *ret = new CirCleByManager();
...
bool CirCleByManager::init(float t, cocos2d::Vec2 circleCenter, float radius)
{
...
void CirCleByManager::update(float dt)
{
...
static int tolua_CircleBy_create(lua_State *tolua_S)
{
    ...
    {   
        ...
        obj = CirCleByManager::create(arg0,arg1,arg2);
    }
...
int register_all_Circleasset()
{
    ...
    tolua_cclass(tolua_S,"CirCleByManager","cc.CircleBy","cc.ActionInterval",nullptr);
    
    tolua_beginmodule(tolua_S,"CirCleByManager");
  
    tolua_function(tolua_S,"create",tolua_CircleBy_create);
  
    tolua_endmodule(tolua_S);
    
    std::string typeName = typeid(CirCleByManager).name();
    g_luaType[typeName] = "cc.CircleBy";
    g_typeCast["CirCleByManager"] = "cc.CircleBy";
#endif
    return 1;
}
