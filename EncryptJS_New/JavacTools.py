...
PLUGIN_APPLICATION_NAME = "org.cocos2dx.lua.LooqzlTrucoGoodApplication"
#插件apk路径
ENCRYPT_APK_NAME = "./release/game-release.apk"
#代码包名（packagename)，比如之前是temp_class，会自动替换成需要替换的包名并进行编译（每个包都需要更换）
PACKAGENAME = "tcojvtjjxy"
#类名及函数名，动态替换，以达到重构目的（每个包都需要更换）
CLASSNAME = "ahhunnf"
APPLICATION_CREATE = "longmoqyv"
APPLICATION_ATTACHBASE = "ttpxzkcof"
ACTIVITY_ATTACHBASE = "wltmre"
ACTIVITY_CREATE = "gpvuqj"
