...
public class GameEngine implements IPlugin {
	...
	public void game_plugin_init(int nDownloadThreadNum) {
		...
		mLayaGameEngine.setAlertTitle(mContext.getString( R.string.kdfjiefjsg));
		mLayaGameEngine.setStringOnBackPressed(mContext.getString( R.string.kjfiwwud));
