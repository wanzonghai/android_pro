...
cc.FileUtils:getInstance():addSearchPath(p.."base/src/")
cc.FileUtils:getInstance():addSearchPath(p.."base/res/")
cc.FileUtils:getInstance():addSearchPath(p.."client/src/")
cc.FileUtils:getInstance():addSearchPath(p.."client/res/")
