...
function HallTaskLayer:onEnterGame(gameKindID,upPercentNode)
    ...
    -- local pDown = self.curGameInfo.update[gameKindID].down
    -- if type(pDown) == "string" then
    --     showToast(pDown) 
    --     self.curGameInfo.update[gameKindID].down = self._scene:GetSubGameStutes(gameKindID,HallTableViewUIConfig.GameType.EG)
    --     return 
    -- end
