...
{
    "GUI/shuiguo/friut_icon_1.png",
    "GUI/shuiguo/friut_icon_2.png",
    "GUI/shuiguo/friut_icon_3.png",
    "GUI/shuiguo/friut_icon_4.png",
    "GUI/shuiguo/friut_icon_5.png",
    "GUI/shuiguo/friut_icon_6.png",
    "GUI/shuiguo/friut_icon_7.png",
    "GUI/shuiguo/friut_icon_8.png",
    "GUI/shuiguo/friut_icon_9.png",
    "GUI/shuiguo/friut_icon_10.png",
    "GUI/shuiguo/friut_icon_11.png",
}
...
function GameItem:setItemType(nType)
    ...
    if nType <= GameLogic.ITEM_LIST.ITEM_ICON8 then
        image_1:loadTexture(GameItem.Texture_fruit[nType + 1])
