...
function GameViewLayer:setFreeNodeVisible(_bFreeStatus)
    ...
    local strBgFile = _bFreeStatus and "GUI/SweetBonanza_beijtu_bg.png" or "GUI/SweetBonanza_beij_bg.png"
...
function GameViewLayer:checkFlushBtnShow(_newStatus)
    ...
    if oldStatus ~= _newStatus then
        local btnFile = {
            ...
            {"GUI/SweetBonanza_auto_but.png", "GUI/SweetBonanza_auto_but.png", "GUI/SweetBonanza_heibaiauto_but.png"},
