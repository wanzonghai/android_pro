...
function HelpLayer:ctor()
    local csbNode = g_ExternalFun.loadCSB(Game_CMD.RES_PATH .. "help/HelpLayer.csb", self)
    ...
    for i = 1, 24 do
        ...
        if i == 22 then
            fish_bg:getChildByName("Text_1"):setString('fixed bomb')
        elseif i == 23 then
            fish_bg:getChildByName("Text_1"):setString('scope bomb')
        elseif i == 24 then
            fish_bg:getChildByName("Text_1"):setString('full bomb')
        end
    end

    --大三元
    local fish_bg = scrollview:getChildByName("fish_bg_25")
    local text_1 = fish_bg:getChildByName("Text_1")
    text_1:setString('big ternary 1')
    text_1:setScale(0.85)
    for i = 1, 3 do
    ...
    text_1 = fish_bg:getChildByName("Text_1")
    text_1:setString('big ternary 2')
    text_1:setScale(0.85)
    for i = 1, 3 do
    ...
    text_1 = fish_bg:getChildByName("Text_1")
    text_1:setString('big ternary 3')
    text_1:setScale(0.85)
    for i = 1, 3 do
    ...
    for i = 31, 40 do
        ...
        local fish_bg = scrollview:getChildByName(string.format("fish_bg_%02d", i))
        local text_1 = fish_bg:getChildByName("Text_1")
        text_1:setString(string.format("fish king%d", i - 30))
    ...
    fish_bg = scrollview:getChildByName("fish_bg_41")
    text_1 = fish_bg:getChildByName("Text_1")
    text_1:setString('random coins')
    text_1:setScale(0.95)
end
