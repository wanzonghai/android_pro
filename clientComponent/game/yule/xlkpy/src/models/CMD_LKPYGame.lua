...
--音效
cmd.Small_0  = "sound_res/small_0.mp3"
cmd.Small_1  = "sound_res/small_1.mp3"
cmd.Small_2  = "sound_res/small_2.mp3"
cmd.Small_3  = "sound_res/small_3.mp3"
cmd.Small_4  = "sound_res/small_4.mp3"
cmd.Small_5  = "sound_res/small_5.mp3"
...
cmd.Shell_8        = "sound_res/SHELL_8.mp3"

cmd.Small_Begin    = "sound_res/SMALL_BEGIN.mp3"
cmd.SmashFail      = "sound_res/SmashFail.mp3"
...
cmd.SupplyType =  g_ExternalFun.declarEnumWithTable(0,enumScoreType)
...
cmd.RoomType = g_ExternalFun.declarEnumWithTable(0,enumRoomType)
...
cmd.PropObjectType = g_ExternalFun.declarEnumWithTable(0,enumPropObjectType)
...
cmd.FishState = g_ExternalFun.declarEnumWithTable(0,enumFishState)
-----------------------------------------------------------------------------------------------
...
cmd.SUB_C_FISH_DEATH	    = 170               --鱼死亡或游出屏幕外

cmd.SUB_C_LOCK_FINISH       = 171
