...
function GameRoomListLayer:ctor(scene, frameEngine, isQuickStart)
	...
	cc.FileUtils:getInstance():addSearchPath(device.writablePath.."game/yule/jxlw/res")
...
--    ExternalFun.createDebugBox(fastButton)
    ...
    cc.exports.roomListLayerGold = function()
        self.userScore:setString(string.formatNumberThousands(GlobalUserItem.lUserScore,true, ':'))
    end
