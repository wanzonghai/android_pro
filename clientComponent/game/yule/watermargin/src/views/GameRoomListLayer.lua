...
local RPPoomListLayer = appdf.req(appdf.CLIENT_SRC.."plaza.views.layer.plaza.RPPoomListLayer")

local GameRoomListLayer = class("GameRoomListLayer", RPPoomListLayer)
--游戏房间列表
