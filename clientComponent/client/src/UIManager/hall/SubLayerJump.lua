...
function SubLayerJump:onAddEventListen()
   ...
   G_event:AddNotifyEvent(G_eventDef.UI_SHOW_HALLRECOMMENDLAYER,handler(self,self.onShowRecommendLayer))   --推荐游戏
...
function SubLayerJump:onRemoveListen()
   ...
   --  G_event:RemoveNotifyEvent(G_eventDef.UI_SHOW_HALLFIRSTGIFTLAYER)
    ...
    G_event:RemoveNotifyEvent(G_eventDef.UI_SHOW_HALLRECOMMENDLAYER)
...
function SubLayerJump:onShowModifyBankPsdLayer(args)
    appdf.req(luaPath.modifyBankPsdLayer).new(args)
   end
...
function SubLayerJump:onShowRecommendLayer(args)
   appdf.req(luaPath.hallRecommendLayer).new(args)
end
