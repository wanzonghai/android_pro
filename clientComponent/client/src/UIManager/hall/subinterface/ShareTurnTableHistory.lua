...
function ShareTurnTableHistory:ctor()
...
function ShareTurnTableHistory:getTableView()
    local tab = cc.TableView2:create(cc.size(1453,656))
    ...
    tab:setPosition(cc.p(92,147.76))
