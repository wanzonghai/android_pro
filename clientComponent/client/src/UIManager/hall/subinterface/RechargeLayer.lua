...
function RechargeLayer:onGoodBuyClick(target)
    ...
    if GlobalData.GiftEnable and not self.TodayRecharge and pData.dwPrice and pData.dwPrice< GlobalData.ShopThreshold then
...
function RechargeLayer:onPayUrlResult(data)    
    ...
    local imagePath = "client/res/recharge/sp_coin"..pItemIndex..".png"
    -- local info = {}
