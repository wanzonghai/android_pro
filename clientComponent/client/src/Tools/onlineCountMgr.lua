...
function onlineCountMgr:remoteUpOnlineCount(data)
    ...
    for k,v in pairs(data.lsItems) do
        ...
        self.m_allOnlineData[v.wKindID*100 + v.wServerKind*10 + v.wSortID] = self.m_allOnlineData[v.wKindID*100 + v.wServerKind*10 + v.wSortID] or 0
        self.m_allOnlineData[v.wKindID*100 + v.wServerKind*10 + v.wSortID]= v.dwOnLineCount
    end
