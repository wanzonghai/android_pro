...
local clickEventUrl = "https://aldk74my.easygameapi.com/api/client/logs/report" --https://stat.easygameapi.com/api/client/logs/report"--正式
...
function EventPost:addCommond(eventType,desc,value,oneLineTime,ext_json)
    ...
    local pTime = os.time()
    if GlobalData.serverTime and GlobalData.serverTime.llServerTime and GlobalData.serverTime.dwZone then
        pTime = GlobalData.serverTime.llServerTime  + GlobalData.serverTime.dwZone*3600
    end
