...
eventDefine.NET_GET_PRODUCT_EXTEND_FLAG                    = "net_get_product_extend_flag"         --获取商城商品扩展标识
...
eventDefine.NET_WITHDRAW_CASH_LIMIT_RESULT                   = "GetWithdrawCashLimit"         --获取提现金额限制
...
eventDefine.EVENT_SHAREPHONE_DATA                  = "EVENT_SHAREPHONE_DATA"        --分享手机号码数据集返回
...
eventDefine.UI_SHOW_GUIDE_BIND                        = "ui_show_guide_bind"                           --短信验证引导页
eventDefine.UI_SHOW_MESSAGE                        = "ui_show_message"                           --打开短信页
eventDefine.UI_SHOW_GUIDE                        = "ui_show_guide"                           --绑定成功引导界面
...
eventDefine.UI_SHOW_HALL_VIP_REWARD                       = "ui_show_hall_vip_reward"                          --打开VIP领奖界面
eventDefine.EVENT_VIP_GIFT_STATUS                   = "event_vip_gift_status"                --获取成长等级界面礼包状态 返回
eventDefine.EVENT_VIP_TAKE_GIFT_RESULT               = "event_vip_take_gift_result"                --提取成长礼包 返回
eventDefine.EVENT_VIP_GET_LEVEL_CONFIG               = "event_vip_get_level_config"                --获取成长等级配置 返回
...
eventDefine.GetLastWithdrawRecord                      = "GetLastWithdrawRecord"          --提现的时候判断是否充值过
...
eventDefine.CHANGE_HEAD                           = "CHANGE_HEAD_Layer"             --改变头像界面
eventDefine.ShareTurnreceiveInfosReceive          = "ShareTurnreceiveInfosReceive"  --分享界面奖励信息返回
eventDefine.ShareTurnreceiveInfosReceiveGet       = "ShareTurnreceiveInfosReceiveGet"   --领取奖励信息返回
eventDefine.shareVipDescrible                     = "shareVipDescrible"             --分享VIP信息
eventDefine.RECEIVE_VIP_ANDGIFT                   = "RECEIVE_VIP_ANDGIFT"             --vip和回扣对应关系返回
eventDefine.RECEIVE_VIP_ANDGIFT2                  = "RECEIVE_VIP_ANDGIFT2"             --vip和回扣对应关系返回
eventDefine.showSHAREPHONEDATA                    = "showSHAREPHONEDATA"             --分享手机号数据返回
eventDefine.UI_OPEN_COMMON_DIALOG                 = "UI_COMMONDIALOG"             --大厅通用弹框
eventDefine.TIXIAN_LEVEL_DATA                     = "TIXIAN_LEVEL_DATA"           --提现挡位数据
eventDefine.UI_SHOW_SELECTLAYER                   = "UI_SHOW_SELECTLAYER"         --选择挡位界面
eventDefine.SET_TIXIAN_LEVEL_RECEIVE              = "SET_TIXIAN_LEVEL_RECEIVE"         --设置提现挡位返回
eventDefine.TUDO_DENTRO_DATA                      = "TUDO_DENTRO_DATA"              --点击全部抽奖
eventDefine.UI_OPEN_RECHARGECODE                  = "UI_OPEN_RECHARGECODE"          --打开商城充值界面
eventDefine.UI_SHOW_PG_LIST                       = "UI_SHOW_PG_LIST"               --打开PG游戏列表
eventDefine.PLinko_CONNECT_SUCCESS                = "PLinko_CONNECT_SUCCESS"        --Plinko短线重连后
eventDefine.ShareGiftBoxInfo                      = "ShareGiftBoxInfo"              --拉新宝箱
eventDefine.ShareGift_Config                      = "ShareGift_Config"              --拉新配置  
eventDefine.ShareGiftBoxReceive                   = "ShareGiftBoxReceive"           --分享拉新领取宝箱奖励
eventDefine.ShareGetNewBenefitConfig              = "ShareGetNewBenefitConfig"      --分享拉新奖励配置
eventDefine.CMD_MB_SharePayRebateGetStatus        = "CMD_MB_SharePayRebateGetStatus"    --分享拉新奖励用户状态
eventDefine.CMD_MB_SharePayRebateGetRecord        = "CMD_MB_SharePayRebateGetRecord"    --获取拉新奖励记录
eventDefine.CMD_MB_SharePayRebateTakeReward       = "CMD_MB_SharePayRebateTakeReward"   --领取拉新奖励返回
return eventDefine