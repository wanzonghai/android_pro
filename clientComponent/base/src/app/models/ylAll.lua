...
ylAll.HotfixUrl = {
    {
        "http://192.168.1.105/BrazilLocal/",                  --巴西金币项目(Truco Clube) A*本地
        "http://192.168.1.230:888/Brazil/",                   --巴西金币项目(Truco Clube) 内网(230)
        "https://down.happyday66.com/brazil_res/",            --巴西金币项目(Truco Clube) 外网(平行服)
        "https://down.9oeh2.com/brazil_res/",                 --巴西金币项目(Truco Clube) 外网(正式服)
    },
    {
        "http://192.168.1.105/ComponentLocal/",               --巴西真金项目(Truco King) A*本地
        "http://192.168.1.230:888/Component/",                --巴西真金项目(Truco King) 内网(230)
        "https://down2.gngqyxxk.com/brazil_res/",             --巴西真金项目(Truco King) 外网(平行服)        
...
ylAll.ServerUrl = {
    {
        ServerLocal~="" and ServerLocal or "115@192.168.1.230:2701|1",                      --巴西金币项目(Truco Clube) 开发服
        "116@192.168.1.230:2701|1",                                                         --巴西金币项目(Truco Clube) 内网(230)
        "117@8.218.73.66:2701|1",                                                           --巴西金币项目(Truco Clube) 外网(平行服)
        "10@152.32.197.243:2701|1",                                                         --巴西金币项目(Truco Clube) 外网(正式服)
    },
    {
        ServerLocal~="" and ServerLocal or "215@8.212.0.246:2701|1",                         --巴西真金项目(Truco King) 开发服 暂未提供
        "216@8.212.0.246:2701|1",                                                            --巴西真金项目(Truco King) 内网   暂未提供
        "217@8.212.0.246:2701|1",                                                            --巴西真金项目(Truco King) 外网(平行服)
