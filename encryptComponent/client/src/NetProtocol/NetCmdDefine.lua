...
NetCmdDefine.MAIN_MDM_MB_LOGON						= 8			--手机登录
...
NetCmdDefine.C_SUB_LOGON_MOBILE2 					= 7             --手机再登录
NetCmdDefine.SUB_MB_SendLogonMobileCode             = 120           --手机登录时发送验证码
NetCmdDefine.CUB_MB_SendLogonMobileCode             = 121           --手机登录时发送验证码返回
NetCmdDefine.C_SUB_RELOGON       					= 10            --大厅断线
NetCmdDefine.S_SUB_RELOGON       					= 10            --大厅断线结果返回
...
NetCmdDefine.C_SUB_USER_FACE_INFO			    	= 122			--修改头像信息
...
NetCmdDefine.SUB_MB_GetLastWithdrawRecord                 = 1228          --获取最后一笔提现记录
NetCmdDefine.SUB_MB_GetLastWithdrawRecordResult           = 1229          --返回：获取最后一笔提现记录
...
NetCmdDefine.SUB_MB_GetGrowLevelConfig              = 1500          --获取成长等级配置 1500
NetCmdDefine.SUB_MB_GetGrowLevelConfigResult        = 1501          --获取成长等级配置 返回 1501
NetCmdDefine.SUB_MB_GetVIPInfo                      = 1502          --查询用户VIP信息 1502
NetCmdDefine.SUB_MB_GetVIPInfoResult                = 1503          --查询用户VIP信息返回 1503
NetCmdDefine.SUB_MB_GetGrowUserGift                 = 1504          --获取成长等级界面礼包状态 1504
NetCmdDefine.SUB_MB_GetGrowGiftStatusResult         = 1505          --获取成长等级界面礼包状态 返回  1505
NetCmdDefine.SUB_MB_TakeGrowGift                    = 1506          --提取成长礼包 发送  1506
NetCmdDefine.SUB_MB_TakeGrowGiftResult              = 1507          --提取成长礼包 返回 1507
...
NetCmdDefine.CMD_MB_GetPiggyInfo  = 1590             --存钱罐  请求 1590
NetCmdDefine.CMD_MB_GetPiggyInfoResult  = 1591       --存钱罐  返回 1591
...
NetCmdDefine.S_SHARE_PHONE_DATA                     = 1278           --分享手机号请求
NetCmdDefine.C_SHARE_PHONE_DATA                     = 1279           --分享手机号请求返回    
--游戏相关
...
--API游戏接入
NetCmdDefine.S_ENTRY_API_GAME				        = 270			--进入EG游戏
...
NetCmdDefine.SUB_MB_SendBindMobileCode		        = 1288			--绑定手机绑定奖励
NetCmdDefine.CUB_MB_SendBindMobileCode		        = 1289			--绑定手机绑定奖励返回
...
NetCmdDefine.packTest_CMD_MB_ShareLotteryGetSpreadRewardStatus    = 1712 		--获取推荐奖励信息 20230506
NetCmdDefine.packTest_CMD_MB_ShareLotteryGetSpreadRewardStatus2    = 1713 		--获取推荐奖励信息返回
NetCmdDefine.packTest_CMD_MB_ShareLotteryTakeSpreadReward    = 1714 			--领取取推荐奖励信息 20230506
NetCmdDefine.packTest_CMD_MB_ShareLotteryTakeSpreadReward2    = 1715 			--领取取推荐奖励信息返回
NetCmdDefine.CMD_MB_GETVIP_GIFT                     = 1716 			--获得推荐奖励回扣vip对应关系
NetCmdDefine.CMD_MB_GETVIP_GIFT_RESULT              = 1717 			--获得推荐奖励回扣vip对应关系返回
NetCmdDefine.CMD_GETTIXIAN_LEVTL                    = 1718			--获得提现挡位
NetCmdDefine.CMD_GETTIXIAN_LEVTL_RECEIVE            = 1719			--获得提现挡位返回
NetCmdDefine.CMD_SETTIXIAN_LEVTL                    = 1720			--设置提现挡位
NetCmdDefine.CMD_SETTIXIAN_LEVTL_RECEIVE            = 1721			--设置提现挡位返回
NetCmdDefine.CMD_TUDO_DENTRO_DATA                   = 1722			--点击全部抽奖
NetCmdDefine.CMD_TUDO_DENTRO_DATA_RECEIVE           = 1723			--点击全部抽奖返回
NetCmdDefine.CMD_MB_SharePayRebateLoadConfig        = 1750          --领取拉新宝箱奖励
NetCmdDefine.SUB_MB_SharePayRebateLoadConfig        = 1751          --领取拉新宝箱奖励返回
NetCmdDefine.CMD_MB_SharePayRebateGetStatus         = 1752          --领取拉新宝箱奖励用户状态
NetCmdDefine.SUB_MB_SharePayRebateGetStatus         = 1753          --领取拉新宝箱奖励用户状态返回
NetCmdDefine.CMD_MB_SharePayRebateGetRecord         = 1754          --获取返利记录
NetCmdDefine.SUB_MB_SharePayRebateGetRecord         = 1755          --获取返利记录返回
NetCmdDefine.CMD_MB_SharePayRebateTakeReward        = 1756          --领取拉新奖励  
NetCmdDefine.SUB_MB_SharePayRebateTakeReward        = 1757          --领取拉新奖励返回
NetCmdDefine.CMD_REQUEST_SHARE_CONFIG               = 1760          --请求拉新配置信息
NetCmdDefine.SUB_REQUEST_SHARE_CONFIG               = 1761          --请求拉新配置信息返回
NetCmdDefine.CMD_REQUEST_BoxInfo                      = 1762          --请求宝箱信息
NetCmdDefine.SMD_REQUEST_BoxInfo                      = 1763          --请求宝箱信息返回
NetCmdDefine.CMD_MB_ShareTreasureChestTakeReward      = 1764          --领取拉新宝箱奖励
NetCmdDefine.SUB_MB_ShareTreasureChestTakeReward      = 1765          --领取拉新宝箱奖励返回
NetCmdDefine.SUB_MB_GetProductExtendFlag                = 1780          --获取商城商品扩展标识
NetCmdDefine.SUB_MB_GetProductExtendFlagResult           = 1781          --返回：商城商品扩展标识

NetCmdDefine.SUB_MB_GetWithdrawCashLimit                 = 1782          --获取提现金额限制
NetCmdDefine.SUB_MB_GetWithdrawCashLimitResult           = 1783          --返回：获取提现金额限制
