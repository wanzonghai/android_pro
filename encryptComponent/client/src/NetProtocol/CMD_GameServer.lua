...
--银行命令
------
game_cmd.MDM_GR_INSURE = 15												   --用户信息
--命令
...
game_cmd.CMD_GR_C_EnableInsureRequest =
{
	...
	{t = "dword", k = "dwUserID"},
	-- 登陆密码
	{t = "tchar", k = "szLogonPass", s = G_NetLength.LEN_PASSWORD},
	-- 银行密码
	{t = "tchar", k = "szInsurePass", s = G_NetLength.LEN_PASSWORD},
	-- 机器序列
...
game_cmd.CMD_GR_C_TakeScoreRequest = 
{
	...
	--银行密码
	{k = "szInsurePass", t = "tchar", s = G_NetLength.LEN_PASSWORD}
}
...
game_cmd.CMD_GP_C_TransferScoreRequest = 
{
	...
	-- 目标用户
	{t = "tchar", k = "szAccounts", s = G_NetLength.LEN_ACCOUNTS},
	-- 银行密码
	{t = "tchar", k = "szInsurePass", s = G_NetLength.LEN_PASSWORD},
	-- 转账备注
	{t = "tchar", k = "szTransRemark", s = G_NetLength.LEN_TRANS_REMARK},
}
...
game_cmd.tagTaskParameter = 
{
	...
	-- 描述信息
	-- 任务名称
	{t = "string", k = "szTaskName", s = G_NetLength.LEN_TASK_NAME},
	-- 任务描述
...
--道具命令
------
game_cmd.MDM_GR_PROPERTY							= 18									--道具命令
...
game_cmd.CMD_GF_C_UserChat = 
{
	...
	{k = "szChatString", t = "tchar", s = G_NetLength.LEN_USER_CHAT},				--聊天内容
}
...
game_cmd.CMD_GF_S_UserChat = 
{
	...
	--这里不能限定读取长度，会异常。。。, s = G_NetLength.LEN_USER_CHAT
...
{
	{k = "wErrorCode", t = "word"},											--错误码  0 正确 1 错误 2 费用不足
	{k = "wItemIndex", t = "word"},											--表情索引
	{k = "dwSendUserID", t = "dword"},										--发送用户id
	{k = "dwTargerUserID", t = "dword"},									--目标用户id
}
