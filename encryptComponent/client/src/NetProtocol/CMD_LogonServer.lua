...
--获取成长等级界面礼包状态 1504
login.CMD_MB_GetGrowUserGift = {
	{t='dword',     k='dwUserID',},                         --UserID	
}

--获取成长等级配置 1500
login.CMD_MB_GetGrowLevelConfig = {
	{t='dword',     k='dwUserID',},                         --UserID	
}

login.CMD_MB_TagGift = {
	{t='byte',      k='cbStatus1',},                   	--当前奖励的状态：1未激活 2 可领取 3已领取
	{t='score',      k='llScore1',},                   	--当前等级可领取的奖励，真金服需要除以100
	{t='score',      k='llNextScore1',},                   	--下一级可领取到的奖励，真金服需要除以100
}

--获取成长等级界面礼包状态 返回  1505
login.CMD_MB_GetGrowGiftStatusResult = {
	{t='byte',      k='cbGrowLevel',},                   	--VIP等级
															-- WeekGift, MonthGift, GrowGift;  // 当前等级 周礼金、月礼金、成长礼金
	{t='table',      k='WeekGift',	d = login.CMD_MB_TagGift, l = {1}},                   	--周礼金
	{t='table',      k='MonthGift',	d = login.CMD_MB_TagGift, l = {1}},                   	--月礼金
	{t='table',      k='GrowGift',	d = login.CMD_MB_TagGift, l = {1}},                   	--成长礼金
}

--提取成长礼包 发送  1506
login.CMD_MB_TakeGrowGift = {
	{t='dword',     k='dwUserID',},                         					--UserID	
	{t='tchar',     k='szDynamicPass',       s=G_NetLength.LEN_PASSWORD,},    	--动态密码
	{t='tchar',     k='szIP',          s=16,},                    		-- IP地址
	{t='byte',      k='cbTypeID',},                   							--1表示周礼金，2表示月礼金, 3表示成长礼金
}

login.CMD_MB_TagLevelup = {
	{t='byte',      k='cbLevel',},                   	--达到的等级
	{t='score',      k='llScore',},                   	--所得分 真金服需要除以100
}

--提取成长礼包 返回 1507
login.CMD_MB_TakeGrowGiftResult = {
	{t='dword',      k='dwErrorCode',},                   	--返回码
	{t='byte',      k='cbTypeID',},                   	--1表示周礼金，2表示月礼金，3表示成长礼金
	{t='word',      k='wCount',},                   	--如果用户升级的时候跳级，则可能有多个成长礼金下发,但周月礼金只有1个
	{t='table',      k='lsItem',	d = login.CMD_MB_TagLevelup},                   
...
--返回存钱罐信息
login.CMD_MB_GetPiggyInfoResult = {
	{t='score',     k='llScore',},                         -- 存钱罐信息
}
...
login.CMD_MB_ShareLotteryGetUserStatusResult= {
	...
	{t="dword", k="dwStageID"},			-- 20230526 提现档位ID,如果为0表示必须设置提现档位才能进行转盘抽奖
	{t="dword", k="dwWithdrawCount"},	-- 20230526 提现次数,如果为0表示用户从未提现过，即【新用户】,具体用途见协议1718/1720
...
local ShareLotteryUserData = {
	...
	{t = "byte", k= "cbGrowLevel"},        -- 成长等级 新增
    {t = "score", k= "llSpreadScore"}     -- 推广返利 20230506新增
}
...
--获取推荐奖励信息 20230506
login.CMD_MB_ShareLotteryGetSpreadRewardStatusResult = {
    {t="score", k="llCurrentSpreadScore"},
    {t="score", k="llMaxSpreadScore"},
    {t="dword", k="dwPayUserCount"}
}

-- 领取取推荐奖励信息返回
login.packTest_CMD_MB_ShareLotteryTakeSpreadReward = {
    {t="score", k="llScore"}
}

login.CMD_MB_Relogon = {
	{t='dword',     k='dwErrorCode',            },                       
	{t='dword',     k='dwUserID',             	},                         
	{t='dword',     k='dwGameID',          		},                    
	{t='tchar',     k='szDynamicPass',       s=G_NetLength.LEN_PASSWORD,},
