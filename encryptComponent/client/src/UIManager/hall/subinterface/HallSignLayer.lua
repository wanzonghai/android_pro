...
function HallSignLayer:setSevenContinousInfo()
    ...
    local maxValue4 = 100
    if wSeriesDays <= 7 then
        self.mm_dayLoadBar:setPercent(wSeriesDays / 7 * maxValue1)
    elseif wSeriesDays <= 10 then
        self.mm_dayLoadBar:setPercent((wSeriesDays - 7) / 3 * (maxValue2 - maxValue1) + maxValue1)
    elseif wSeriesDays <= 15 then
        self.mm_dayLoadBar:setPercent((wSeriesDays - 10) / 5 * (maxValue3 - maxValue2) + maxValue2)
    elseif wSeriesDays <= 20 then
        self.mm_dayLoadBar:setPercent((wSeriesDays - 15) / 5 * (maxValue4 - maxValue3) + maxValue3)
    end
