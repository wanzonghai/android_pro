...
luaPath.ShareVipDescrible = perPath.."ShareVipDescrible.lua"
...
luaPath.hallGuideBind = perPath.."authentication/HallGuideBind.lua"  --短信验证引导页
luaPath.hallMessageLayer = perPath.."authentication/HallMessageLayer.lua"  --短信验证
luaPath.hallGuideLayer = perPath.."authentication/HallGuideLayer.lua"  --验证成功引导礼包页
...
luaPath.hallVIPRewardLayer = perPath.."HallVIPRewardLayer.lua"                --VIP领奖界面
...
luaPath.ChangeHeadLayer = perPath.."ChangeHeadLayer.lua"      --改变头像
luaPath.SharePhoneLayer = perPath.."SharePhoneLayer.lua"        --分享手机号数据返回
luaPath.CommonDialog = perPath.."CommonDialog.lua"        --大厅通用提示框
luaPath.ShareSelectLayer = perPath.."ShareSelectLayer.lua"        --挡位选择界面
luaPath.RechargeQrCodeLayer = perPath.."RechargeQrCodeLayer.lua"        --商城支付扫码界面
luaPath.HallPGLayer = "client.src.UIManager.hall.HallPGLayer.lua"                      --大厅PG游戏列表
