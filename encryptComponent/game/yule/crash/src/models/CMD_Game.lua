...
cmd.SERVER_LEN					= 32
cmd.LEN_NICKNAME                = 32
cmd.SERVER_SEEDLEN              = 68
cmd.MAX_SCORE_HISTORY           = 20
...
--游戏倒计时
cmd.kGAMEEND_COUNTDOWN			= 1
cmd.kGAMEPLAY_COUNTDOWN			= 2
cmd.kGAMEOPEN_COUNTDOWN			= 3
...
--请求10条记录
cmd.SUB_S_SEND_GAMERECORD       = 120
--请求用户下注记录
cmd.SUB_S_SEND_ADDBETRECORD     = 115
--停止倍数
cmd.SUB_S_END_BETCRASH          = 116
--停止倍数失败
cmd.SUB_S_END_BETCRASH_FAIL     = 117
--开奖信息
cmd.SUB_S_END_OPEN_NUM          = 118
---------------------------------------------------------------------------------------
...
cmd.CMD_S_StatusFree = 
{
    ...
    {k = "dwBetScore", t = "dword", l = {cmd.RECORD_LEN}},           --下注额度列表
    --房间信息 SERVER_LEN										
    {k = "szGameRoomName", t = "string", s = cmd.SERVER_LEN},					--房间名称
    {k = "bGenerEducate", t = "bool"},	                             --是否练习场	
    {k = "dwBetScoreConfig", t = "dword", l = {18}},           --下注配置表			
    {k = "dwMultipleConfig", t = "dword", l = {18}},           --倍数配置表			
}
...
{
	--全局信息					
    {k = "cbTimeLeave", t = "int"},					    --剩余时间，毫秒级
    {k = "dwBetScore", t = "dword", l = {cmd.RECORD_LEN}}, --下注额度列表
    {k = "cbAllTime", t = "int"},                       --总跑过的时间，毫秒级
    -- 总时间的计算：timerount = sqrt(m_openNum - 1)* m_StepTime
    {k = "cbTimeStep", t = "int"},                      --除去步长 调整速度快慢
    {k = "cbGameStatus", t = "byte"},					--游戏状态
    --下注数 AREA_MAX
    {k = "lPlayBet", t = "score"},	                    --自己总下注
    {k = "lPlayBetScore", t = "score"},					--玩家最大下注，没用到
    {k = "lBetCrash", t = "int"},                       --玩家下的Crash（倍数）

    --玩家输赢 AREA_MAX
    {k = "lPlayAllScore", t = "score"},                 --玩家成绩,没用到
    {k = "lRevenue", t = "score"},						--税收

    --开奖号码
    {k = "openNum", t = "int"},
    {k = "isPressBetCrash", t = "byte"},                   --是否点击停止按钮,0没点，1点过了
...
--游戏开奖
cmd.CMD_S_End_Open_Num = 
{
    --开奖时间戳
    {k = "lbet_timer", t = "dword"},
    --开奖号码
    {k = "openNum", t = "int"},
    --剩余时间,真实跑线的时间
    {k = "cbTimeLeave", t = "int"},
    --多延迟时间 可能实在6秒
    {k = "opencrashwaittimer", t = "int"},
    --除去步长 调整速度快慢
    {k = "steptimer", t = "int"},
}
...
cmd.CMD_S_ServerOpenGameRecord = 
{
    ...
    --页数,从0开始
    {k = "openNum", t = "int", l = {cmd.MAX_SCORE_HISTORY}}
}
...
{
    {k = "chairId", t = "int"}, --椅子id
    {k = "betCrash", t = "int"}, --下注的倍数
    {k = "betScore", t = "score"}, --下注的分数
}
...
--请求停止
cmd.SUB_C_END_BETCRASH              = 9
---------------------------------------------------------------------------------------

--用户停止
cmd.CMD_C_End_BetCrash = 
{
	--用户位置
	{k = "wChairID", t = "word"},
	--筹码区域
