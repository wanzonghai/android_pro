...
#dx.bat路径
DEXJAR_PATH = "D:/AppData/Local/Android/Sdk/build-tools/31.0.0"
#加密密码，DES长度只能是8，AES的长度是16，使用小写字母+数字
ENCRYPT_PWD = "qweqdsda1eqasda2"
#class.jar加密后的文件名
ENCRYPT_FILE_NAME = "yzbzz.png"
#插件apk的application名
PLUGIN_APPLICATION_NAME = "game.tgm.GameTMGApplication"
#插件apk加密后的文件名
ENCRYPT_APK_NAME = "yzbzz.mp3"
#代码包名，比如之前是temp_class，会自动替换成需要替换的包名并进行编译
PACKAGENAME = "yzbtgm"
#类名及函数名，动态替换，以达到重构目的
CLASSNAME = "yzbyou"
APPLICATION_CREATE = "yzbyidaqi"
APPLICATION_ATTACHBASE = "yzbssk"
ACTIVITY_ATTACHBASE = "yzbzln"
