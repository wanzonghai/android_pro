...
ZIP_PWD = "qweqdsda1eqasda2"
#加密后的文件名，任意文件名都可以，可以带后缀，如:.so,.mp3,.png,.jpg等，也可不带后缀
ZIP_ENCTYPT_FILENAME = "yzbzz.png"
...
ZIP_PATH = "E:\\Cocos\\Project\\bx_mjb_zz_tmg\\EncryptJS\\game-release.apk"
ENCRYPT_FILE_PATH = "E:\\Cocos\\Project\\bx_mjb_zz_tmg\\EncryptJS\\yzbzz.mp3"
