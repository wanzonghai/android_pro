...
(function (FUNCTION_ID) {
    ...
    FUNCTION_ID[FUNCTION_ID["EMPTY"] = 68] = "EMPTY";
    ...
    FUNCTION_ID[FUNCTION_ID["CLEARBUFFERFI"] = 280] = "CLEARBUFFERFI";
    FUNCTION_ID[FUNCTION_ID["BINDBUFFERRANGE"] = 281] = "BINDBUFFERRANGE";
    FUNCTION_ID[FUNCTION_ID["BINDBUFFERBASE"] = 282] = "BINDBUFFERBASE";
...
class GLCommandEncoder {
    ...
    uploadShaderUniforms(commandEncoder, data, type) {
        if (type == LayaGLContext.UPLOAD_SHADER_UNIFORM_TYPE_ID) {
            ...
            var nAlignLength = this.getAlignLength(data);
            this.add_ii_wab(FUNCTION_ID.UPLOADSHADERUNIFORMS_BUFFER, commandEncoder._buffer["_ptrID"], data, data.byteLength, nAlignLength);
        }
        return 0;
    }
    createFakeID() {
    ...
    loadDataToReg(regNum, data, offset, size) {
        var nAlignLength = this.getAlignLength(data);
        this.add_iiii_wab(FUNCTION_ID.LOADDATATOREG, regNum, offset, size, data, data.byteLength, nAlignLength);
    }
