(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":1920,"designHeight":1080,"screenMode":"horizontal","backgroundColor":"rgba(0, 0, 0, 1)","scaleMode":"fixedheight","alignV":"top","alignH":"left"},"3D":{"lightClusterCount":{"x":12,"y":12,"z":12},"enableStaticBatch":true,"enableDynamicBatch":true,"defaultPhysicsMemory":16,"enableUniformBufferObject":true,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":16,"useBVHCull":false,"BVH_max_SpatialCount":7,"BVH_limit_size":32,"BVH_Min_Build_nums":10},"splash":{"fit":"center","enabled":true,"duration":1},"2D":{"FPS":60,"isAntialias":true,"useRetinalCanvas":false,"isAlpha":false,"webGL2D_MeshAllocMaxMem":true},"spineVersion":"3.8","stat":false,"vConsole":false,"alertGlobalError":false,"startupScene":"HelpScene.ls"}`);
