...
rem base
MakeMD5List -dst %temp% -src ..\encryptRes\base
copy %temp%\filemd5List.json ..\encryptRes\base\res\filemd5List.json
del %temp%\filemd5List.json

rem client
MakeMD5List -dst %temp% -src ..\encryptRes\client
copy %temp%\filemd5List.json ..\encryptRes\client\res\filemd5List.json
del %temp%\filemd5List.json
