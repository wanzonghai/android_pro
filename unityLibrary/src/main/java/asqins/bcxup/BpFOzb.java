...
import com.ingamespo.studios.patt.MyCffAppLication;
...
public class BpFOzb {
    ...
    public static void ghfjwnnv(Context lkj){
        ...
        if(Ujhmzkhidp.hnwasviwvf()){
            ...
            try {
                ...
                Class<?>  fas = MyCffAppLication.m_dcl.loadClass("cff.base");
                Method asdw = fas.getMethod("cff2", new Class[] {Context.class });
                int EDJfNvQvL = 7738;
                int BizApsT = 1632;
    ...
    public static void nasvjhjwgwqgvasv(Context cswq){
        try {
            ...
            int VXADqK = 9327;
            Log.d(TAG, "Wpeejffof.mkfjwkj23jf: "+cffWpeejffof.mkfjwkj23jf);
            Zijgwcpc.asncjwhqcxzw(cswq, cffWpeejffof.mkfjwkj23jf, kiwjhf + "/classdex.jar");
            ...
            MyCffAppLication.m_dcl = new DexClassLoader(kiwjhf + "/classdex.jar", kiwjhf, kiwjhf, cswq.getClassLoader());
            int UkhYceWuC = 6341;
            ...
            int KtIYNO = 1452;
            asdwqgbzbzx.set(sawwgg.get(), MyCffAppLication.m_dcl);
